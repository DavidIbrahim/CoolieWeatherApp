...
object Dependencies {
    ...
    const val kotlin_extensions = "org.jetbrains.kotlin:kotlin-android-extensions-runtime:${Versions.kotlin}"
    ...
    const val apollo_cache = "com.apollographql.apollo:apollo-normalized-cache-sqlite:${Versions.apollo}"

    const val android_preferences = "androidx.preference:preference-ktx:${Versions.androidx_preferences}"
